...
const NavBar = () => {
  ...
  <Box className='titulo' >
     * PowerEcommerce *<svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" class="bi bi-battery-charging" viewBox="0 0 16 16">
